...
public class InnerMainPt2 { private static ArrayList<Albums> albums = new ArrayList<>();

    public static void main(String[] args) {

        Albums album = new Albums("Flume (Deluxe Edition)", "Flume");
        ...
        album = new Albums("In Colour", "Jamie XX");
        ...
        LinkedList<Tracks> playList = new LinkedList<>();
    ...
    private static void play(LinkedList<Tracks> playList) {
        Scanner scanner = new Scanner(System.in);
        boolean quit = false;
        boolean forward = true;
        ListIterator<Tracks> listIterator = playList.listIterator();

        if (playList.size() == 0) {
            System.out.println("No tracks are in playlist.");
            return;
        } else {
    ...
    public static void printList(LinkedList<Tracks> playList) {
        Iterator<Tracks> iterator = playList.iterator();
        System.out.println("------------------------");
